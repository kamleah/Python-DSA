...
class CircularDoublyLinkedList:
    ...
    # Iterator for the circular doubly linked list
    def __iter__(self):
        node = self.head
        while node:
            yield node
    ...
    # Traverse and print values of the circular doubly linked list
    ...
    # Reverse traversal and print values of the circular doubly linked list
    ...
    # Search for a node with a given value in the circular doubly linked list
...
# Create an instance of the circular doubly linked list
circularDLL = CircularDoublyLinkedList()

# Create and manipulate the circular doubly linked list
